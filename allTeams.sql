...
--
-- Table structure for table `NJY`
--

DROP TABLE IF EXISTS `NJY`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `NJY` (
  `record` int(10) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `NJY`
--

LOCK TABLES `NJY` WRITE;
/*!40000 ALTER TABLE `NJY` DISABLE KEYS */;
/*!40000 ALTER TABLE `NJY` ENABLE KEYS */;
UNLOCK TABLES;
